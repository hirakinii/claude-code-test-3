...
- [ ] スキーマ取得APIが動作する
- [ ] カテゴリCRUD APIがすべて動作する
- [ ] フィールドCRUD APIがすべて動作する
- [ ] デフォルト復元APIが動作する
- [ ] フロントエンドでスキーマ設定画面が表示される
- [ ] カテゴリ・フィールドのCRUD操作がUIから実行できる
- [ ] ドラッグ&ドロップで順序変更ができる
...
- [ ] APIドキュメント（Swagger/OpenAPI）の更新
- [ ] READMEの更新（Phase 2完了の記載）
